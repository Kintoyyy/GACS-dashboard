...
if (empty($currentPassword) || empty($newUsername)) {
    jsonResponse(['success' => false, 'message' => 'The current password and new username must be entered']);
}
...
if ($user = $result->fetch_assoc()) {
    if (!password_verify($currentPassword, $user['password'])) {
        jsonResponse(['success' => false, 'message' => 'The current password is incorrect']);
    }
